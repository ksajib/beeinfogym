...
<head>
    ...
    <style>
        ...
        /* dompdf table layout to simulate columns */
        .main-table {
            width: 100%;
            ...
            <tr>
                <td class="sidebar">
                    ...
                    <div class="sidebar-section">
                        ...
                        <div class="sidebar-item"><strong>Mobile:</strong> {{ $user->profile->primary_mobile ?? 'N/A' }}
                        </div>
                        @if ($user->profile->secondary_mobile)
                            <div class="sidebar-item"><strong>Alt Mobile:</strong>
                                {{ $user->profile->secondary_mobile }}</div>
                        @endif
                        <div class="sidebar-item"><strong>Email:</strong> {{ $user->profile->email ?? $user->email }}
                        </div>
                    ...
                    <div class="sidebar-section">
                        ...
                        <div class="sidebar-item"><strong>Nationality:</strong>
                            {{ $user->profile->nationality ?? 'N/A' }}</div>
                        <div class="sidebar-item"><strong>Religion:</strong> {{ $user->profile->religion ?? 'N/A' }}
                        </div>
                        @if ($user->profile->nid)
                ...
                <td class="content">
                    ...
                    @forelse($user->educations as $edu)
                        <div class="item-row">
                            ...
                            <p class="item-desc">Result: {{ $edu->result }} (Grade System: {{ $edu->grade_system }})
                            </p>
                        </div>
                    @empty
                        ...
                        <div class="item-row">
                            <table class="item-header-table">
                                <tr>
                                    ...
                                    <td class="item-meta">{{ $training->duration }} {{ $training->duration_type }}
                                    </td>
                                </tr>
                            </table>
                        ...
                        <div class="item-row">
                            <table class="item-header-table">
                                <tr>
                                    ...
                                    <td class="item-meta">
                                        {{ $ach->date ? \Carbon\Carbon::parse($ach->date)->format('M Y') : '' }}</td>
                                </tr>
                            </table>

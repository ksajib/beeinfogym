<section id="values" class="section-pad" style="background:var(--black);">
    <div class="container px-0">
        <div class="text-center mb-5 mx-auto" style="max-width:600px;">
            <div class="cheadline cheadline-center">What We Stand For</div>
            <h2 class="section-title text-light">The principles we live by</h2>
            <p class="feat-hero-desc mx-auto">Not marketing words — these are the commitments driving every feature,
                every support call, and every new partnership we build.</p>
        </div>
        <div class="val-grid">
            <div class="val-card rv">
                ...
                <p class="val-text">Every decision starts with one question: does this make life better for gym members
                    and owners? If not, it doesn't ship.</p>
            </div>
            <div class="val-card">
                <div class="val-card-line"></div>
                ...
                <p class="val-text">We release new features every month, driven by real feedback from gym owners. The
                    fitness world moves fast — we move faster.</p>
            </div>
            <div class="val-card">
                <div class="val-card-line"></div>
                ...
                <p class="val-text">Our support team works non-stop. When your gym opens at 5am, we're already awake.
                    When it closes at midnight, we're still here.</p>
            </div>
            <div class="val-card">
                <div class="val-card-line"></div>
                ...
                <p class="val-text">Bank-grade encryption protects every member record and every transaction. Your data
                    is yours — always private, always safe.</p>
            </div>
        </div>
    </div>
</section>

<section id="related" class="section-pad" style="background: var(--black);">
    <div class="container px-0">
        <div class="text-center mx-auto mb-5">
            <div class="cheadline cheadline-center">Related Policies</div>
            <h2 class="section-title text-light">Other legal documents</h2>
        </div>
        <div class="row g-4">
            <div class="col-md-4">
                <a href="terms.html" class="related-card">
                    ...
                    <p>Understand your rights and responsibilities as a BeeInfo user, including payment terms, account
                        rules, and governing law.</p>
                    <div class="related-link">Read Policy <i class="bi bi-arrow-right"></i></div>
                </a>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <a href="data-deletion-request.html" class="related-card">
                    ...
                    <p>Submit a formal request to permanently delete your personal data, biometric records, and account
                        from BeeInfo systems.</p>
                    <div class="related-link">Contact Us <i class="bi bi-arrow-right"></i></div>
                </a>
            </div>
        </div>
    </div>
